...
const PROJECT_URL = `${API_BASE_URL}/api/project`;
const PROJECTS_URL = `${API_BASE_URL}/api/projects`; // For listing all projects
const FOLDER_URL = `${API_BASE_URL}/api/folder`;
const DASHBOARD_URL = `${API_BASE_URL}/api/dashboard`;
const TILE_URL = `${API_BASE_URL}/api/tile`;
